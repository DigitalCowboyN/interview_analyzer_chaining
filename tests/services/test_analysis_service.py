...
def test_build_contexts_success(analysis_service: AnalysisService, mock_context_builder: MagicMock) -> None:
...
async def test_analyze_sentences_classify_error(
    ...
    expected_results = [
        ...
        {
            "sentence_id": 1, "sequence_order": 1, "sentence": "s2_fail",
            "error": True, "error_type": "ValueError", "error_message": "API Error"
        }
    ]
    mock_timer = create_mock_timer()
