...
graph LR
    ...
    n_code_tools_graph_check["code:tools.graph.check"] --> n_code_tools_graph_flow["code:tools.graph.flow"]
...
graph LR
    ...
    n_code_tools_graph["code:tools.graph"] --> n_code_tools_graph_flow["code:tools.graph.flow"]
...
graph LR
    ...
    n_adr_20["adr:20"] --> n_code_tools_graph_flow["code:tools.graph.flow"]
...
graph LR
    ...
    n_tests_code_test_emits["tests:code.test_emits"] --> n_code_tools_code["code:tools.code"]
    ...
    n_tests_graph_test_flow_checks["tests:graph.test_flow_checks"] --> n_code_tools_graph["code:tools.graph"]
    ...
    n_tests_graph_test_reads_edge["tests:graph.test_reads_edge"] --> n_code_tools_graph["code:tools.graph"]
...
```mermaid
graph LR
    n_graph_queries_reader_analysis_rows["graph-queries:reader.analysis_rows"] --> n_glossary_Analysis["glossary:Analysis"]
    n_graph_queries_reader_analysis_rows["graph-queries:reader.analysis_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_analysis_rows["graph-queries:reader.analysis_rows"] --> n_glossary_FunctionType["glossary:FunctionType"]
    n_graph_queries_reader_analysis_rows["graph-queries:reader.analysis_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_analysis_rows["graph-queries:reader.analysis_rows"] --> n_glossary_Keyword["glossary:Keyword"]
    n_graph_queries_reader_analysis_rows["graph-queries:reader.analysis_rows"] --> n_glossary_Purpose["glossary:Purpose"]
    n_graph_queries_reader_analysis_rows["graph-queries:reader.analysis_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_analysis_rows["graph-queries:reader.analysis_rows"] --> n_glossary_StructureType["glossary:StructureType"]
    n_graph_queries_reader_analysis_rows["graph-queries:reader.analysis_rows"] --> n_glossary_Topic["glossary:Topic"]
    n_graph_queries_reader_claim_rows["graph-queries:reader.claim_rows"] --> n_glossary_Claim["glossary:Claim"]
    n_graph_queries_reader_claim_rows["graph-queries:reader.claim_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_claim_rows["graph-queries:reader.claim_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_context_rows["graph-queries:reader.context_rows"] --> n_glossary_Entity["glossary:Entity"]
    n_graph_queries_reader_context_rows["graph-queries:reader.context_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_context_rows["graph-queries:reader.context_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_context_rows["graph-queries:reader.context_rows"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_context_rows["graph-queries:reader.context_rows"] --> n_glossary_Segment["glossary:Segment"]
    n_graph_queries_reader_context_rows["graph-queries:reader.context_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_context_rows["graph-queries:reader.context_rows"] --> n_glossary_Utterance["glossary:Utterance"]
    n_graph_queries_reader_entity_rows["graph-queries:reader.entity_rows"] --> n_glossary_CanonicalEntity["glossary:CanonicalEntity"]
    n_graph_queries_reader_entity_rows["graph-queries:reader.entity_rows"] --> n_glossary_Entity["glossary:Entity"]
    n_graph_queries_reader_entity_rows["graph-queries:reader.entity_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_entity_rows["graph-queries:reader.entity_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_entity_rows["graph-queries:reader.entity_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_entity_surface_rows["graph-queries:reader.entity_surface_rows"] --> n_glossary_Entity["glossary:Entity"]
    n_graph_queries_reader_entity_surface_rows["graph-queries:reader.entity_surface_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_entity_surface_rows["graph-queries:reader.entity_surface_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_entity_surface_rows["graph-queries:reader.entity_surface_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_fulltext_rows["graph-queries:reader.fulltext_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_fulltext_rows["graph-queries:reader.fulltext_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_graph_anchor_rows["graph-queries:reader.graph_anchor_rows"] --> n_glossary_CanonicalEntity["glossary:CanonicalEntity"]
    n_graph_queries_reader_graph_anchor_rows["graph-queries:reader.graph_anchor_rows"] --> n_glossary_Entity["glossary:Entity"]
    n_graph_queries_reader_graph_anchor_rows["graph-queries:reader.graph_anchor_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_graph_anchor_rows["graph-queries:reader.graph_anchor_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_graph_anchor_rows["graph-queries:reader.graph_anchor_rows"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_graph_anchor_rows["graph-queries:reader.graph_anchor_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_graph_anchor_rows["graph-queries:reader.graph_anchor_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_interview_exists["graph-queries:reader.interview_exists"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_interview_header_row["graph-queries:reader.interview_header_row"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_interview_rows["graph-queries:reader.interview_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_interview_rows["graph-queries:reader.interview_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_interview_rows["graph-queries:reader.interview_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_lens_item_rows["graph-queries:reader.lens_item_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_lens_item_rows["graph-queries:reader.lens_item_rows"] --> n_glossary_LensItem["glossary:LensItem"]
    n_graph_queries_reader_lens_item_rows["graph-queries:reader.lens_item_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_name_rows["graph-queries:reader.name_rows"] --> n_glossary_CanonicalEntity["glossary:CanonicalEntity"]
    n_graph_queries_reader_name_rows["graph-queries:reader.name_rows"] --> n_glossary_Entity["glossary:Entity"]
    n_graph_queries_reader_name_rows["graph-queries:reader.name_rows"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_person_card_rows["graph-queries:reader.person_card_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_person_card_rows["graph-queries:reader.person_card_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_person_card_rows["graph-queries:reader.person_card_rows"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_person_card_rows["graph-queries:reader.person_card_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_person_card_rows["graph-queries:reader.person_card_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_person_contributes_to_persona["graph-queries:reader.person_contributes_to_persona"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_person_contributes_to_persona["graph-queries:reader.person_contributes_to_persona"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_person_contributes_to_persona["graph-queries:reader.person_contributes_to_persona"] --> n_glossary_LensItem["glossary:LensItem"]
    n_graph_queries_reader_person_contributes_to_persona["graph-queries:reader.person_contributes_to_persona"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_person_contributes_to_persona["graph-queries:reader.person_contributes_to_persona"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_person_contributes_to_persona["graph-queries:reader.person_contributes_to_persona"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_person_detail_rows["graph-queries:reader.person_detail_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_person_detail_rows["graph-queries:reader.person_detail_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_person_detail_rows["graph-queries:reader.person_detail_rows"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_person_detail_rows["graph-queries:reader.person_detail_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_person_detail_rows["graph-queries:reader.person_detail_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_person_display_name_row["graph-queries:reader.person_display_name_row"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_person_display_name_row["graph-queries:reader.person_display_name_row"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_person_display_name_row["graph-queries:reader.person_display_name_row"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_person_display_name_row["graph-queries:reader.person_display_name_row"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_person_display_name_row["graph-queries:reader.person_display_name_row"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_person_exists["graph-queries:reader.person_exists"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_person_exists["graph-queries:reader.person_exists"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_person_exists["graph-queries:reader.person_exists"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_person_exists["graph-queries:reader.person_exists"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_person_exists["graph-queries:reader.person_exists"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_person_rows["graph-queries:reader.person_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_person_rows["graph-queries:reader.person_rows"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_person_rows["graph-queries:reader.person_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_persona_card_rows["graph-queries:reader.persona_card_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_persona_card_rows["graph-queries:reader.persona_card_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_persona_card_rows["graph-queries:reader.persona_card_rows"] --> n_glossary_LensItem["glossary:LensItem"]
    n_graph_queries_reader_persona_card_rows["graph-queries:reader.persona_card_rows"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_persona_card_rows["graph-queries:reader.persona_card_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_persona_card_rows["graph-queries:reader.persona_card_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_persona_detail_rows["graph-queries:reader.persona_detail_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_persona_detail_rows["graph-queries:reader.persona_detail_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_persona_detail_rows["graph-queries:reader.persona_detail_rows"] --> n_glossary_LensItem["glossary:LensItem"]
    n_graph_queries_reader_persona_detail_rows["graph-queries:reader.persona_detail_rows"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_persona_detail_rows["graph-queries:reader.persona_detail_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_persona_detail_rows["graph-queries:reader.persona_detail_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_persona_exists["graph-queries:reader.persona_exists"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_persona_exists["graph-queries:reader.persona_exists"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_persona_exists["graph-queries:reader.persona_exists"] --> n_glossary_LensItem["glossary:LensItem"]
    n_graph_queries_reader_persona_exists["graph-queries:reader.persona_exists"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_persona_exists["graph-queries:reader.persona_exists"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_persona_exists["graph-queries:reader.persona_exists"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_project_exists["graph-queries:reader.project_exists"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_project_exists["graph-queries:reader.project_exists"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_project_rows["graph-queries:reader.project_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_project_rows["graph-queries:reader.project_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_segment_rows["graph-queries:reader.segment_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_segment_rows["graph-queries:reader.segment_rows"] --> n_glossary_Segment["glossary:Segment"]
    n_graph_queries_reader_speaker_rollup_rows["graph-queries:reader.speaker_rollup_rows"] --> n_glossary_Claim["glossary:Claim"]
    n_graph_queries_reader_speaker_rollup_rows["graph-queries:reader.speaker_rollup_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_speaker_rollup_rows["graph-queries:reader.speaker_rollup_rows"] --> n_glossary_LensItem["glossary:LensItem"]
    n_graph_queries_reader_speaker_rollup_rows["graph-queries:reader.speaker_rollup_rows"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_speaker_rollup_rows["graph-queries:reader.speaker_rollup_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_speaker_rollup_rows["graph-queries:reader.speaker_rollup_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_speaker_rows["graph-queries:reader.speaker_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_speaker_rows["graph-queries:reader.speaker_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_speaker_rows["graph-queries:reader.speaker_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_speaker_rows["graph-queries:reader.speaker_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_speaker_rows["graph-queries:reader.speaker_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_transcript_line_rows["graph-queries:reader.transcript_line_rows"] --> n_glossary_Entity["glossary:Entity"]
    n_graph_queries_reader_transcript_line_rows["graph-queries:reader.transcript_line_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_transcript_line_rows["graph-queries:reader.transcript_line_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_transcript_line_rows["graph-queries:reader.transcript_line_rows"] --> n_glossary_LensItem["glossary:LensItem"]
    n_graph_queries_reader_transcript_line_rows["graph-queries:reader.transcript_line_rows"] --> n_glossary_Person["glossary:Person"]
    n_graph_queries_reader_transcript_line_rows["graph-queries:reader.transcript_line_rows"] --> n_glossary_Segment["glossary:Segment"]
    n_graph_queries_reader_transcript_line_rows["graph-queries:reader.transcript_line_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_transcript_line_rows["graph-queries:reader.transcript_line_rows"] --> n_glossary_Utterance["glossary:Utterance"]
    n_graph_queries_reader_transcript_rows["graph-queries:reader.transcript_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_transcript_rows["graph-queries:reader.transcript_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_transcript_rows["graph-queries:reader.transcript_rows"] --> n_glossary_Speaker["glossary:Speaker"]
    n_graph_queries_reader_transcript_rows["graph-queries:reader.transcript_rows"] --> n_glossary_Utterance["glossary:Utterance"]
    n_graph_queries_reader_vector_fragment_rows["graph-queries:reader.vector_fragment_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_vector_fragment_rows["graph-queries:reader.vector_fragment_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_vector_utterance_rows["graph-queries:reader.vector_utterance_rows"] --> n_glossary_Fragment["glossary:Fragment"]
    n_graph_queries_reader_vector_utterance_rows["graph-queries:reader.vector_utterance_rows"] --> n_glossary_Interview["glossary:Interview"]
    n_graph_queries_reader_vector_utterance_rows["graph-queries:reader.vector_utterance_rows"] --> n_glossary_Project["glossary:Project"]
    n_graph_queries_reader_worklist_rows["graph-queries:reader.worklist_rows"] --> n_glossary_Claim["glossary:Claim"]
    n_graph_queries_reader_worklist_rows["graph-queries:reader.worklist_rows"] --> n_glossary_Interview["glossary:Interview"]
