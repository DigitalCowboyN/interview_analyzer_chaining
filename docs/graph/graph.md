...
graph LR
    ...
    n_tests_integration_test_anthropic_api_messages["tests:integration.test_anthropic_api_messages"] --> n_code_agents["code:agents"]
    ...
    n_tests_integration_test_openai_api_responses["tests:integration.test_openai_api_responses"] --> n_code_agents["code:agents"]
