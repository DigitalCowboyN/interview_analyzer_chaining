...
class AnalysisResult(BaseModel):
    ...
    function_type: str = Field(..., description="The classified functional type of the sentence (e.g., declarative)")
    structure_type: str = Field(..., description="The classified structural type of the sentence (e.g., simple)")
    purpose: str = Field(..., description="The classified purpose of the sentence (e.g., Statement)")
    topic_level_1: str = Field(..., description="The Level 1 topic classification based on immediate context")
    topic_level_3: str = Field(..., description="The Level 3 topic classification based on broader context")
    overall_keywords: List[str] = Field(..., description="List of keywords representing the main overall topics")
    domain_keywords: List[str] = Field(..., description="List of domain-specific keywords found in the sentence")
